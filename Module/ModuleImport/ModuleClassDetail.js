...
app.harmony.system.Module.ModuleImport.ModuleClassDetail = function(config){
	Ext.apply(this, config);
	app.harmony.system.Module.ModuleImport.ModuleClassDetail.superclass.constructor.call(this, config);
};
/**
 ...
 * @extends Ext.Panel
 */
Ext.extend(app.harmony.system.Module.ModuleImport.ModuleClassDetail,app.harmony.system.BaseClass.DetailPanel,{
	dataDetail : {
        autoHeight: true,
        autoWidth: false,
