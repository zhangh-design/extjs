...
app.harmony.system.Module.ModuleImport.ClassImportFieldTBar = function(config){
	Ext.apply(this, config);
	app.harmony.system.Module.ModuleImport.ClassImportFieldTBar.superclass.constructor.call(this, config);
}
Ext.extend(app.harmony.system.Module.ModuleImport.ClassImportFieldTBar,app.harmony.system.BaseClass.GridTBar, {
	import_e : function(){
