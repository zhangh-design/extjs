...
app.harmony.system.Module.LogManage.OnlineOperatorTBar = function(config){
	Ext.apply(this, config);
	app.harmony.system.Module.LogManage.OnlineOperatorTBar.superclass.constructor.call(this, config);
}
Ext.extend(app.harmony.system.Module.LogManage.OnlineOperatorTBar,app.harmony.system.BaseClass.GridDefinedTBar, {   
	query_e : function(){
		this.initParams();
